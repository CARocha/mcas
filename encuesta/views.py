...
def __spss(request):
    ...
    for encuesta in encuestas:
        ...
        filas.append(encuesta.get_iglesia_display())
        ...
        for familia in familias:
            ...
            filas.append(','.join(map(unicode, familia.vive_con.all().values_list(u'nombre',flat=True))))
        ...
        for conocimiento in conocimientos:
            filas.append(', '.join(map(unicode, conocimiento.abuso.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, conocimiento.lugares.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, conocimiento.quien_abusa.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, conocimiento.que_hacer.all().values_list(u'nombre',flat=True))))
            filas.append(conocimiento.get_conoce_ley_display())
            filas.append(', '.join(map(unicode, conocimiento.nombre_ley.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, conocimiento.donde_aprendio.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, conocimiento.donde_informarse.all().values_list(u'nombre',flat=True))))
        actitudes = encuesta.actitud_set.all()
        for actitud in actitudes:
            filas.append(', '.join(map(unicode, actitud.porque_abuso.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, actitud.que_piensa.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, actitud.que_piensa_victimas.all().values_list(u'nombre',flat=True))))
        ...
        for practica in practicas:
            filas.append(', '.join(map(unicode, practica.que_haria.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, practica.que_hago_prevenir.all().values_list(u'nombre',flat=True))))
            filas.append(practica.get_participa_prevenir_display())
            filas.append(', '.join(map(unicode, practica.como.all().values_list(u'nombre',flat=True))))  
        ...
        for estado in estados:
            ...
            filas.append(', '.join(map(unicode, estado.lugares.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, estado.tipo_atencion.all().values_list(u'nombre',flat=True))))
        ...
        for percepcion in percepciones:
            ...
            filas.append(', '.join(map(unicode, percepcion.que_familia.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, percepcion.quien_debe.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, percepcion.mensaje.all().values_list(u'nombre',flat=True))))
            filas.append(percepcion.get_defender_display())
            filas.append(', '.join(map(unicode, percepcion.rol_medios.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, percepcion.rol_iglesia.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, percepcion.rol_estado.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, percepcion.rol_ongs.all().values_list(u'nombre',flat=True))))
            filas.append(', '.join(map(unicode, percepcion.rol_empresas.all().values_list(u'nombre',flat=True))))
...
def familia_jefe(request):
    ...
    grafo_url = grafos.make_graph(valores, leyenda, '¿Quién es el jefa/e de familia?', type=grafos.PIE_CHART_3D, pie_labels=True)
